...
function renderVisualMap() {
    ...
    ctx.strokeStyle = 'rgba(141, 119, 95, 0.4)'; // Цвет утоптанной земли
    ctx.setLineDash([10, 5]); // Более длинные штрихи
    ctx.lineWidth = 3; // Дороги стали заметнее
