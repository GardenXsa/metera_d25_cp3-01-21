...
function saveSettings() {
    ...
    if (modelKeyMap[provider]) localStorage.setItem(modelKeyMap[provider], modelId);
    ...
    localStorage.setItem('musicVolume', document.getElementById('music-volume-slider')?.value || 0.2);
    localStorage.setItem('sfxVolume', document.getElementById('sfx-volume-slider')?.value || 0.3);
