...
3. События должны быть масштабными (войны, союзы, крах рынков, эпидемии).
4. В поле 'narrative' пиши в стиле исторической хроники или Вестей из Эфира.
5. Твой ответ ДОЛЖЕН БЫТЬ СТРОГО ВАЛИДНЫМ JSON ОБЪЕКТОМ следующего формата:
{
  "narrative": "Твой художественный текст о глобальном событии...",
  "actions": [
    { "command": "команда", "args": {} }
  ]
}`;
