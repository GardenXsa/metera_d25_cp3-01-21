...
// ======================================================================
const BASE_ECONOMY_PRICES = { food: 1, wood: 2, ore: 4, herbs: 6, steel: 12, cloth: 10, weapons: 35, potions: 30, luxury: 80 };
...
function initWorldSimulator() {
    ...
    let newWorld = {
        ...
        regions: {}, factions: {}, npcs: {}, news: [], animals: {}, weather: {}
    };
    ...
    // --- ЛОРНЫЕ НАСТРОЙКИ ФРАКЦИЙ И ВЛАДЕНИЙ ---
    if (currentEra === 'architects') {
        fConfig = {
            "orthodoxy": { name: "Ортодоксия Решетки", g: [80000, 120000], f: [20000, 30000], m: [15000, 25000], stab: 90 },
            "syndicate": { name: "Синдикат Экспансии", g: [100000, 150000], f: [10000, 15000], m: [10000, 20000], stab: 80 },
            "greencode": { name: "Фракция Зеленого Кода", g: [20000, 40000], f: [50000, 80000], m: [5000, 10000], stab: 85 },
            "ascendancy": { name: "Культ Перехода", g: [30000, 50000], f: [5000, 10000], m: [8000, 15000], stab: 60 },
            "apostates": { name: "Апостаты Пустоты", g: [10000, 20000], f: [2000, 5000], m: [20000, 30000], stab: 40 }
        };
        locMap = {
            "nexus_prime": "orthodoxy", "solar_citadel": "orthodoxy", "obsidian_wall": "orthodoxy",
            "sky_harbor": "syndicate", "silver_conduits": "syndicate",
            "whispering_gardens": "greencode", "aethel_spires": "greencode", "genesis_craters": "greencode",
            "arcanum_archive": "ascendancy", "crystal_matrix": "ascendancy", "bio_forge": "ascendancy",
            "void_bastion": "apostates", "resonance_pits": "syndicate", "deep_sea_obs": "orthodoxy"
        };
    } else if (currentEra === 'silence') {
        fConfig = {
            "iron_remnant": { name: "Железный Остаток", g: [5000, 10000], f: [2000, 5000], m: [8000, 12000], stab: 85 },
            "flesh_cult": { name: "Культ Плоти", g: [1000, 3000], f: [8000, 15000], m: [10000, 20000], stab: 50 },
            "heralds": { name: "Вестники Безмолвия", g: [0, 1000], f: [1000, 2000], m: [15000, 25000], stab: 99 },
            "logic_purge": { name: "Орден Логической Чистки", g: [20000, 30000], f: [0, 0], m: [5000, 10000], stab: 100 },
            "scavengers": { name: "Падальщики Нексуса", g: [10000, 20000], f: [3000, 6000], m: [4000, 8000], stab: 40 }
        };
        locMap = {
            "iron_remnant_base": "iron_remnant", "rusting_spires": "iron_remnant",
            "flesh_craft_pits": "flesh_cult", "bone_fields": "flesh_cult",
            "forgotten_obs": "heralds", "muted_valley": "heralds",
            "deep_vault_7": "logic_purge", "crystal_wastes": "logic_purge",
            "scrap_canyon": "scavengers", "aquilon_ruins": "scavengers", "sunken_haven": "scavengers",
            "ash_desert": "scavengers", "silent_forest": "flesh_cult", "dead_lake": "flesh_cult", "whispering_dunes": "scavengers"
        };
    } else if (currentEra === 'sundering') {
        fConfig = {
            "survivors": { name: "Выжившие Аквилона", g: [5000, 10000], f: [2000, 4000], m: [3000, 6000], stab: 30 },
            "mutants": { name: "Улей Мутантов", g: [0, 0], f: [10000, 20000], m: [20000, 40000], stab: 90 },
            "storm_cult": { name: "Культ Эфирного Шторма", g: [2000, 5000], f: [1000, 3000], m: [8000, 15000], stab: 50 },
            "mad_constructs": { name: "Безумные Конструкты", g: [10000, 20000], f: [0, 0], m: [10000, 15000], stab: 100 }
        };
        locMap = {
            "falling_aquilon": "survivors", "ruined_sky_harbor": "survivors", "ashen_coast": "survivors",
            "mutant_hive": "mutants", "flesh_labyrinth": "mutants", "burning_forest": "mutants",
            "expanding_scar": "storm_cult", "storms_eye": "storm_cult", "bleeding_earth": "storm_cult",
            "glass_desert": "mad_constructs", "sunken_arcanum": "mad_constructs", "chasm_of_screams": "mad_constructs",
            "shattered_peaks": "survivors", "void_wastes": "storm_cult", "boiling_sea": "mutants"
        };
    } else { // rebirth
        fConfig = {
            "aquilon": { name: "Аквилонская Директория", g: [30000, 50000], f: [20000, 30000], m: [15000, 25000], stab: 80 },
            "khazadrim": { name: "Кхазадримский Конклав", g: [40000, 60000], f: [8000, 15000], m: [10000, 15000], stab: 90 },
            "sylvanesti": { name: "Сильванестийский Симбиоз", g: [5000, 10000], f: [40000, 60000], m: [5000, 8000], stab: 85 },
            "gronnar": { name: "Гроннарская Орда", g: [2000, 5000], f: [10000, 15000], m: [20000, 30000], stab: 50 },
            "consortium": { name: "Свободные Торговцы", g: [80000, 150000], f: [15000, 25000], m: [5000, 10000], stab: 70 },
            "crimson": { name: "Орден Багрового Пламени", g: [15000, 25000], f: [10000, 15000], m: [8000, 12000], stab: 95 }
        };
        locMap = {
            "capital_aquilon": "aquilon", "ruins_arcanum": "aquilon",
            "thunder_citadel": "khazadrim", "crystal_caves": "khazadrim", "dragon_spine_mountains": "khazadrim",
            "whispering_woods": "sylvanesti", "floating_islands_of_aethel": "sylvanesti",
            "nomad_lands_ash_plains": "gronnar", "the_scarred_wastes": "gronnar", "the_shifting_sands_of_khem": "gronnar",
            "silver_haven": "consortium", "sunken_city_of_aeridor": "consortium",
            "sanctum_of_whispers": "crimson", "ether_scar_chasm": "crimson", "forgotten_observatory": "crimson"
        };
    }

    // 1. Инициализация фракций
    for (let fId in fConfig) {
        let bf = fConfig[fId];
        newWorld.factions[fId] = {
            name: bf.name,
            resources: {
                gold: bf.g[0] + Math.floor(Math.random() * (bf.g[1] - bf.g[0])),
                food: bf.f[0] + Math.floor(Math.random() * (bf.f[1] - bf.f[0])),
                manpower: bf.m[0] + Math.floor(Math.random() * (bf.m[1] - bf.m[0]))
            },
    ...
    // Лорные войны
    if (currentEra === 'rebirth') {
        newWorld.factions["aquilon"].diplomacy["gronnar"] = "war";
        newWorld.factions["gronnar"].diplomacy["aquilon"] = "war";
        newWorld.factions["crimson"].diplomacy["sylvanesti"] = "war";
        newWorld.factions["sylvanesti"].diplomacy["crimson"] = "war";
    }

    // 2. Инициализация регионов с лорной привязкой
    for (let key in globalLocations) {
        if (key === 'startLocation') continue;
        let loc = globalLocations[key];
        // Если для локации не прописан владелец, отдаем случайному (чтобы не было пустых)
        let ownerId = locMap[key] || fKeys[Math.floor(Math.random() * fKeys.length)];

        // Настраиваем экономику под владельца
        let isDwarf = ownerId === 'khazadrim';
        let isElf = ownerId === 'sylvanesti' || ownerId === 'greencode';
        let isTrader = ownerId === 'consortium' || ownerId === 'syndicate';

        newWorld.regions[key] = {
            name: loc.name,
            owner: ownerId,
            climate: "temperate",
            population: 5000 + Math.floor(Math.random() * 45000),
            // Расширенная экономика v2.0
            resources: {
                // Сырье
                food: isElf ? 10000 : Math.floor(Math.random() * 5000),
                wood: isElf ? 10000 : Math.floor(Math.random() * 5000),
                ore: isDwarf ? 15000 : Math.floor(Math.random() * 3000),
                herbs: isElf ? 5000 : Math.floor(Math.random() * 1000),
                // Промышленные товары
                steel: isDwarf ? 2000 : Math.floor(Math.random() * 500),
                cloth: Math.floor(Math.random() * 1000),
                // Конечные товары
                weapons: isDwarf || ownerId === 'aquilon' ? 5000 : Math.floor(Math.random() * 1000),
                potions: isElf ? 1000 : Math.floor(Math.random() * 200),
                luxury: ownerId === 'consortium' ? 2000 : Math.floor(Math.random() * 300)
            },
            moneySupply: 50000 + Math.floor(Math.random() * 100000), // Денежная масса региона
            facilities: {
                farms: isElf ? 15 : Math.floor(Math.random() * 8),
                lumbermills: isElf ? 10 : Math.floor(Math.random() * 5),
                mines: isDwarf ? 20 : Math.floor(Math.random() * 5),
                forges: isDwarf ? 15 : Math.floor(Math.random() * 5),
                weavers: Math.floor(Math.random() * 5) + 1,
                alchemists: isElf ? 5 : Math.floor(Math.random() * 3),
                banks: ownerId === 'consortium' ? 3 : (Math.random() > 0.5 ? 1 : 0)
            },
            markets: { 
                food: 1, wood: 2, ore: 5, herbs: 8, 
                steel: 15, cloth: 10, 
                weapons: 50, potions: 40, luxury: 100 
            },
            caravans: []
        };
        newWorld.weather[key] = "Ясно";
        newWorld.animals[key] = {
            herbivores: isElf ? 10000 : 500 + Math.floor(Math.random() * 2000),
            carnivores: isElf ? 1000 : 50 + Math.floor(Math.random() * 200)
        };
    }
...
function simulateOneHour() {
    ...
    for (let id in World.npcs) {
        ...
        if (npc.needs.hunger < 25) {
            ...
            if (npc.inventory.gold > 0) {
                npc.inventory.gold--;
                npc.needs.hunger = 100;
                npc.currentActivity = "Ест";
                if (Math.random() < 0.05) npc.memory.push({ day: currentDay, text: "Едва не умер от голода." });
            } else {
                // Нет денег - ворует или голодает
                if (npc.personality.greed > 70 || npc.personality.aggression > 60) {
                    npc.currentActivity = "Ворует еду";
                    npc.needs.hunger += 40;
                    npc.personality.aggression += 1;
                } else {
            ...
            npc.needs.rest += 50;
            actionTaken = true;
        } else if (npc.needs.safety < 30) {
            npc.currentActivity = "Прячется";
            npc.needs.safety += 10;
            actionTaken = true;
        }

        // Выполнение расписания, если нет критических нужд
        if (!actionTaken) {
            ...
            if (currentSchedule) {
                ...
                // Если по расписанию нужно быть в другом месте
                if (npc.currentLocation !== currentSchedule.location) {
                    npc.travelDestination = currentSchedule.location;
                    npc.travelHoursLeft = 2; // Условное время пути
                    npc.currentActivity = "Направляется в " + currentSchedule.location;
                } else {
                    // Выполнение работы
                    if (npc.currentActivity === "Работает") {
                        npc.inventory.gold += Math.floor(Math.random() * 3) + 1;
                        npc.needs.rest -= 2;
                    }
                    // Социализация
                    if (npc.currentActivity === "Отдыхает в таверне") {
                        npc.needs.social += 20;
                        // Поиск собеседника в той же локации
                        let potentialFriends = Object.values(World.npcs).filter(n => n.id !== npc.id && n.currentLocation === npc.currentLocation && !n.travelDestination && n.isAlive);
                        if (potentialFriends.length > 0) {
                            ...
                            if (npc.personality.sociability > 50) {
                                ...
                                npc.relationships[friend.id].affection += 1;
                            } else if (npc.personality.aggression > 70) {
                                npc.relationships[friend.id].trust -= 5;
                                npc.relationships[friend.id].fear += 2;
        ...
        npc.needs.safety = Math.max(0, Math.min(100, npc.needs.safety));
        
        // Смерть от голода
        if (npc.needs.hunger === 0 && !npc.plotArmor) {
            npc.isAlive = false;
            npc.currentActivity = "Мертв (Голод)";
            generateWorldNews(`Трагедия в ${World.regions[npc.currentLocation]?.name || npc.currentLocation}: ${npc.name} умер от голода.`, npc.currentLocation, 2);
        }
    }

    // 2. Движение караванов 2.0 (Логистика, Риски и Налоги)
    for (let rId in World.regions) {
        ...
        for (let i = region.caravans.length - 1; i >= 0; i--) {
            ...
            // Риск ограбления в пути (зависит от стабильности целевого региона)
            if (destRegion && Math.random() < 0.005) { // 0.5% шанс каждый час пути
            ...
            if (caravan.hoursLeft <= 0) {
                if (destRegion) {
                    for (let good in caravan.goods) {
                        ...
                        destRegion.resources[good] = (destRegion.resources[good] || 0) + amount;
                        
                        // Продажа по местным ценам
                        let sellPrice = destRegion.markets[good] || BASE_ECONOMY_PRICES[good];
                        let revenue = amount * sellPrice;
                        
                        // Деньги уходят из экономики региона-покупателя (жители платят за импорт)
                        destRegion.moneySupply = Math.max(0, destRegion.moneySupply - revenue);
                        
                        // Налоги оседают в казне фракции (10% торговая пошлина)
                        let faction = World.factions[destRegion.owner];
                        if (faction) {
                            faction.resources.gold += Math.floor(revenue * 0.1);
                        }
                    }
                    if (Math.random() < 0.2) {
                        generateWorldNews(`Караван из ${region.name} благополучно прибыл в ${destRegion.name}, доставив дефицитные товары.`, caravan.destination, 2, 'trade');
                    }
                }
                region.caravans.splice(i, 1);
            }
...
function simulateOneDay() {
    console.log("[WorldSim] Симуляция нового дня (Stage 4: Ecology & Disasters)...");
    ...
    for (let rId in World.regions) {
        ...
        // Стихийные бедствия (1.5% шанс в день на регион)
        if (Math.random() < 0.015) {
            let disasters = ["Землетрясение", "Эпидемия"];
            if (season === "summer" || r.climate === "tropical") disasters.push("Засуха", "Лесной пожар");
            if (season === "winter" || r.climate === "cold") disasters.push("Аномальные морозы");
            if (season === "spring" || season === "autumn") disasters.push("Наводнение", "Ураган");
            
            let disaster = disasters[Math.floor(Math.random() * disasters.length)];
            let damageStr = "";
            
            if (disaster === "Землетрясение") {
                r.population -= Math.floor(r.population * 0.05);
                if (r.facilities.farms > 0) r.facilities.farms--;
                if (r.facilities.mines > 0) r.facilities.mines--;
                damageStr = "Разрушены здания, есть жертвы.";
            } else if (disaster === "Эпидемия") {
                r.population -= Math.floor(r.population * 0.1);
                damageStr = "Ужасающие потери среди населения.";
            } else if (disaster === "Засуха" || disaster === "Лесной пожар") {
                r.resources.food = Math.floor(r.resources.food * 0.3);
                r.resources.wood = Math.floor(r.resources.wood * 0.4);
                damageStr = "Урожай и леса уничтожены.";
            } else {
                r.resources.wood = Math.floor(r.resources.wood * 0.7);
                r.resources.food = Math.floor(r.resources.food * 0.8);
                damageStr = "Пострадали запасы провизии и материалов.";
            }
            generateWorldNews(`СТИХИЙНОЕ БЕДСТВИЕ! В регионе ${r.name} произошло событие: ${disaster}. ${damageStr}`, rId, 5, 'disaster');
        }
    }

    // 2. Продвинутая Экономика (ЭТАП 2: Рынок труда и Производственные цепочки)
    // Используем глобальную BASE_ECONOMY_PRICES
    let rKeys = Object.keys(World.regions);

    for (let rId of rKeys) {
        let r = World.regions[rId];
        
        // Защита от старых сейвов: инициализируем новые поля, если их нет
        if (!r.resources.herbs) r.resources.herbs = 0;
        if (!r.resources.steel) r.resources.steel = 0;
        if (!r.resources.cloth) r.resources.cloth = 0;
        if (!r.resources.potions) r.resources.potions = 0;
        if (!r.resources.luxury) r.resources.luxury = 0;
        if (!r.moneySupply) r.moneySupply = 50000;
        if (!r.facilities.weavers) r.facilities.weavers = 1;
        if (!r.facilities.alchemists) r.facilities.alchemists = 1;

        // --- РЫНОК ТРУДА ---
        let totalWorkforce = Math.floor(r.population * 0.6); // 60% населения трудоспособны
        let jobsPerFacility = 200;
        let totalJobs = (r.facilities.farms + r.facilities.lumbermills + r.facilities.mines + r.facilities.forges + r.facilities.weavers + r.facilities.alchemists) * jobsPerFacility;
        ...
        // Зарплаты и денежная масса
        let avgWage = Math.max(1, Math.floor((r.moneySupply / totalWorkforce) * 0.01)); // Базовая ЗП
        if (unemployed > totalWorkforce * 0.2) avgWage = Math.max(1, avgWage - 1); // Безработица сбивает ЗП
        
        // --- ПРОИЗВОДСТВЕННЫЕ ЦЕПОЧКИ (CRAFTING CHAINS) ---
        ...
        let workersPerSector = activeWorkers / 6; // Упрощенное распределение по 6 секторам

        // 1. Добыча сырья
        r.resources.food += Math.floor(workersPerSector * (r.facilities.farms / 10) * 2 * weatherMod);
        r.resources.wood += Math.floor(workersPerSector * (r.facilities.lumbermills / 10) * weatherMod);
        r.resources.ore += Math.floor(workersPerSector * (r.facilities.mines / 10));
        r.resources.herbs += Math.floor(workersPerSector * (r.facilities.farms / 20) * weatherMod);

        // 2. Промышленность (Полуфабрикаты)
        // Сталь: требует Руду и Дерево (уголь)
        let steelCapacity = Math.floor(workersPerSector * (r.facilities.forges / 10));
        let oreToSteel = Math.min(r.resources.ore, Math.min(r.resources.wood, steelCapacity));
        if (oreToSteel > 0) {
            r.resources.ore -= oreToSteel;
            r.resources.wood -= Math.floor(oreToSteel * 0.5);
            r.resources.steel += Math.floor(oreToSteel * 0.8);
        }

        // Ткань: требует абстрактные волокна (часть еды/трав)
        let clothCapacity = Math.floor(workersPerSector * (r.facilities.weavers / 10));
        let fibersToCloth = Math.min(r.resources.food, clothCapacity); // Используем еду как суррогат агрокультур
        if (fibersToCloth > 0) {
            r.resources.food -= Math.floor(fibersToCloth * 0.2);
            r.resources.cloth += Math.floor(fibersToCloth * 0.5);
        }

        // 3. Конечные товары
        // Оружие: требует Сталь и Дерево
        let weaponCapacity = Math.floor(workersPerSector * (r.facilities.forges / 20));
        let steelToWeapons = Math.min(r.resources.steel, weaponCapacity);
        if (steelToWeapons > 0) {
            r.resources.steel -= steelToWeapons;
            r.resources.wood -= Math.floor(steelToWeapons * 0.2);
            r.resources.weapons += Math.floor(steelToWeapons * 0.3);
        }

        // Зелья: требуют Травы
        let potionCapacity = Math.floor(workersPerSector * (r.facilities.alchemists / 10));
        let herbsToPotions = Math.min(r.resources.herbs, potionCapacity);
        if (herbsToPotions > 0) {
            r.resources.herbs -= herbsToPotions;
            r.resources.potions += Math.floor(herbsToPotions * 0.5);
        }

        // Роскошь: требует Ткань и Сталь (ювелирка/одежда)
        let luxuryCapacity = Math.floor(workersPerSector * (r.facilities.weavers / 20));
        let matsToLuxury = Math.min(r.resources.cloth, Math.min(r.resources.steel, luxuryCapacity));
        if (matsToLuxury > 0) {
            r.resources.cloth -= matsToLuxury;
            r.resources.steel -= Math.floor(matsToLuxury * 0.5);
            r.resources.luxury += Math.floor(matsToLuxury * 0.2);
        }

        // --- ПОТРЕБЛЕНИЕ И УРОВЕНЬ ЖИЗНИ ---
        let foodConsumed = Math.floor(r.population * 0.02);
        let woodConsumed = Math.floor(r.population * 0.005);
        let clothConsumed = Math.floor(r.population * 0.002);
        
        if (World.weather[rId] === "Снег" || World.weather[rId] === "Метель" || World.weather[rId] === "Аномальные морозы") woodConsumed *= 2;
        
        r.resources.food -= foodConsumed;
        r.resources.wood -= woodConsumed;
        r.resources.cloth -= clothConsumed;

        // Последствия дефицита
        if (r.resources.food < 0) {
            r.resources.food = 0;
            let deaths = Math.floor(Math.random() * 100) + 50;
            r.population -= deaths;
            if (Math.random() < 0.2) generateWorldNews(`Голод в ${r.name}! Нехватка продовольствия унесла ${deaths} жизней.`, rId, 4, 'disaster');
        }
        if (r.resources.wood < 0) r.resources.wood = 0;
        if (r.resources.cloth < 0) r.resources.cloth = 0;

        // Бунты из-за безработицы
        if (employmentRate < 0.5 && Math.random() < 0.05) {
            generateWorldNews(`Массовые беспорядки в ${r.name}! Безработные требуют хлеба и работы.`, rId, 3, 'disaster');
            r.resources.weapons = Math.max(0, r.resources.weapons - 50); // Разграбление арсеналов
        }

        // --- ДИНАМИЧЕСКОЕ ЦЕНООБРАЗОВАНИЕ ---
        for (let good in BASE_ECONOMY_PRICES) {
            let supply = r.resources[good] || 1;
            let demand = 0;
            
            // Расчет спроса для каждого товара (заводы хотят сырье, люди хотят готовое)
            if (good === 'food') demand = foodConsumed * 1.5 + clothCapacity;
            else if (good === 'wood') demand = woodConsumed * 1.5 + steelCapacity + weaponCapacity;
            else if (good === 'cloth') demand = clothConsumed * 2 + luxuryCapacity;
            else if (good === 'ore') demand = steelCapacity * 1.5;
            else if (good === 'steel') demand = weaponCapacity + luxuryCapacity * 1.5;
            else if (good === 'herbs') demand = potionCapacity * 1.5;
            else demand = r.population * 0.001; // Базовый спрос на готовые товары

            if (demand < 1) demand = 1;
            
            // Формула цены: База * (Спрос / Предложение). Ограничиваем от 0.2x до 5x
            let priceMod = Math.max(0.2, Math.min(5.0, demand / supply));
            r.markets[good] = Math.max(1, Math.floor(BASE_ECONOMY_PRICES[good] * priceMod));
        }
    }

    // Обновление микро-экономики для именных NPC
    for (let id in World.npcs) {
        let npc = World.npcs[id];
        if (!npc.isAlive) continue;
        ...
        for (let key in World.regions) {
            if (World.regions[key].name === npc.currentLocation) locId = key;
        }
        
        if (locId && World.regions[locId]) {
            let r = World.regions[locId];
            // Шанс найти или потерять работу
            if (!npc.economy.isEmployed) {
                if (Math.random() < (r.facilities.farms + r.facilities.mines) / 100) {
                    npc.economy.isEmployed = true;
                    npc.currentActivity = "Работает на производстве";
                }
            } else {
                if (Math.random() < 0.05) { // 5% шанс увольнения
                    npc.economy.isEmployed = false;
                    npc.currentActivity = "Ищет работу";
                }
            }
            ...
            // Траты на еду (покупают по рыночной цене)
            let foodPrice = r.markets.food || 1;
        ...
        // 3. Торговые караваны 2.0 (Умная логистика)
    for (let rId of rKeys) {
        let r = World.regions[rId];
        for (let good in BASE_ECONOMY_PRICES) {
            ...
            // Купцы ищут, где продать товар с максимальной выгодой
            for (let destId of rKeys) {
                if (destId === rId) continue;
                let dest = World.regions[destId];
                let profitMargin = dest.markets[good] - localPrice;
                
                // Если выгода больше 30% и у нас есть излишки (> 50 единиц)
                if (profitMargin > localPrice * 0.3 && r.resources[good] > 50) {
            ...
            if (bestDest) {
                ...
                // Купец закупает до 20% наших запасов
                let amount = Math.floor(r.resources[good] * 0.2);
                let cost = amount * localPrice;

                if (amount > 0) {
                    r.resources[good] -= amount;
                    r.moneySupply += cost; // Деньги вливаются в экономику региона-поставщика
                    ...
                    r.caravans.push({
                        ...
                        buyPrice: localPrice,
                        investment: cost,
                        hoursLeft: 24 + Math.floor(Math.random() * 48) // От 1 до 3 дней пути
                    });

                    if (Math.random() < 0.15) {
                        generateWorldNews(`Торговая гильдия отправила караван из ${r.name} в ${destRegion.name}. Груз: ${good} (${amount} шт).`, bestDest, 2, 'trade');
                    }
                }
            }
        }
    ...
    // 4. Фракции (Политика, Армии и Войны)
    let fKeys = Object.keys(World.factions);
    for (let fId of fKeys) {
        let f = World.factions[fId];
        if (!f.diplomacy) f.diplomacy = {};
        if (!f.resources.manpower) f.resources.manpower = 1000;
        
        f.resources.gold += 500 + Math.floor(f.stability * 10); 
        f.resources.manpower += 50;
        
        if (f.resources.food < 1000) f.stability -= 2;
        else f.stability += 1;
        f.stability = Math.max(0, Math.min(100, f.stability));

        if (f.stability < 30 && Math.random() < 0.1) {
            generateWorldNews(`Восстание! В землях фракции ${f.name} вспыхнул бунт из-за низкой стабильности.`, "global", 4);
            f.stability += 20;
            f.resources.manpower -= 300;
        }
        ...
        for (let targetF of fKeys) {
            ...
            // МАКСИМАЛЬНАЯ АГРЕССИЯ И ВОЛАТИЛЬНОСТЬ ДИПЛОМАТИИ
            let change = Math.floor(Math.random() * 21) - 10; // от -10 до +10 в день!
            if (f.resources.food < 2000) change -= 5; // Голодные фракции становятся агрессивными
            if (f.resources.gold < 5000) change -= 3; // Бедные ищут кого бы ограбить
            if (currentStatus === "war") change -= 5;
            if (currentStatus === "alliance") change += 5;
            
            f.relations[targetF] = Math.max(-100, Math.min(100, rel + change));
            rel = f.relations[targetF];

            // Порог войны снижен с -80 до -40! Войны будут вспыхивать часто.
            if (rel < -40 && currentStatus !== "war") {
                f.diplomacy[targetF] = "war";
                World.factions[targetF].diplomacy[fId] = "war";
                generateWorldNews(`Фракция ${f.name} объявляет войну ${World.factions[targetF].name}!`, "global", 5, 'war');
            }
            else if (rel > 80 && currentStatus !== "alliance" && currentStatus !== "war") {
                f.diplomacy[targetF] = "alliance";
                World.factions[targetF].diplomacy[fId] = "alliance";
                generateWorldNews(`Фракции ${f.name} и ${World.factions[targetF].name} заключили военный союз.`, "global", 4, 'war');
            }
            else if (rel > -20 && currentStatus === "war") {
                f.diplomacy[targetF] = "neutral";
                World.factions[targetF].diplomacy[fId] = "neutral";
                generateWorldNews(`Фракции ${f.name} и ${World.factions[targetF].name} подписали мирный договор.`, "global", 5, 'war');
            }
        }

        let atWarWith = Object.keys(f.diplomacy).find(k => f.diplomacy[k] === "war");
        // Снижены требования для сбора армии. Воевать будут активнее.
        if (atWarWith && f.resources.gold > 1000 && f.resources.manpower > 300) {
            let targetRegion = Object.keys(World.regions).find(r => World.regions[r].owner === atWarWith) || "capital_aquilon";
            let homeRegion = Object.keys(World.regions).find(r => World.regions[r].owner === fId) || "capital_aquilon";
            
            // ПРЕДОХРАНИТЕЛЬ: Не отправляем новую армию, если наша армия уже идет туда или осаждает этот регион
            let alreadyAttacking = f.armies.some(a => a.destination === targetRegion || a.location === targetRegion);
            
            if (!alreadyAttacking) {
                f.resources.gold -= 1000;
                f.resources.manpower -= 300;
                let armyId = "army_" + Date.now() + Math.floor(Math.random()*1000);
                f.armies.push({ id: armyId, size: 500, morale: 100, location: homeRegion, destination: targetRegion, daysToMove: 3, siegeDays: -1 });
                generateWorldNews(`Армия фракции ${f.name} (500 воинов) выступила в поход на ${World.regions[targetRegion].name}.`, homeRegion, 3, 'war');
            }
        }
            ...
            if (enemyFactionId) {
                ...
                if (atkPower > defPower) {
                    ...
                    generateWorldNews(`Кровавая полевая битва у ${World.regions[targetLoc].name}: Армия ${f.name} разбила войска ${defender.name}! Потери врага: ${casualties}.`, targetLoc, 5, 'war');
                    defender.armies.splice(defArmyIndex, 1);
                } else {
                    let casualties = Math.floor(army.size * 0.8);
                    defArmy.size -= Math.floor(defArmy.size * 0.2);
                    generateWorldNews(`Полевая битва у ${World.regions[targetLoc].name}: Войска ${defender.name} уничтожили армию ${f.name}! Потери нападавших: ${casualties}.`, targetLoc, 5, 'war');
                    f.armies.splice(i, 1);
                    armySurvived = false;
                }
            } 
            // Если вражеской армии нет, но регион враждебный (ОСАДА)
            else if (regionOwner && f.diplomacy[regionOwner] === "war") {
                if (army.siegeDays === -1) {
                    // Начало осады
                    army.siegeDays = Math.floor(Math.random() * 4) + 3; // 3-6 дней осады
                    generateWorldNews(`Армия ${f.name} взяла в осаду город ${World.regions[targetLoc].name}! Город продержится около ${army.siegeDays} дней.`, targetLoc, 4, 'war');
                } else if (army.siegeDays > 0) {
                    // Идет осада
                    army.siegeDays--;
                    World.regions[targetLoc].population -= Math.floor(Math.random() * 100); // Город страдает
                } else {
                    // Штурм после осады
                    let defender = World.factions[regionOwner];
                    let garrisonPower = (World.regions[targetLoc].population / 100) + (World.regions[targetLoc].facilities.farms * 10);
                    let atkPower = army.size * (Math.random() * 0.5 + 0.8);
                    
                    if (atkPower > garrisonPower) {
                        World.regions[targetLoc].owner = fId;
                        generateWorldNews(`ШТУРМ УСПЕШЕН! После долгой осады регион ${World.regions[targetLoc].name} захвачен фракцией ${f.name}!`, targetLoc, 5, 'war');
                    } else {
                        generateWorldNews(`ОСАДА СНЯТА! Ополчение ${World.regions[targetLoc].name} отбило штурм армии ${f.name}. Нападающие разбиты.`, targetLoc, 5, 'war');
                        f.armies.splice(i, 1);
                        armySurvived = false;
                    }
                }
            ...
            // Если армия выжила и больше не осаждает (победила или пришла в мирный город)
            if (armySurvived && f.armies[i] && f.armies[i].siegeDays <= 0) {
                f.resources.manpower += f.armies[i].size;
                f.armies.splice(i, 1);
            }
        }
    }

    // 5. Продвинутая Экология и Миграции
    for (let rId in World.animals) {
        let a = World.animals[rId];
        let r = World.regions[rId];
        
        let eaten = Math.floor(a.carnivores * 2);
        a.herbivores = Math.max(0, a.herbivores - eaten);
        
        let growthRate = (season === "spring" || season === "summer") ? 0.2 : 0.05;
        a.herbivores += Math.floor(a.herbivores * growthRate);
        
        if (a.herbivores < a.carnivores * 2) {
            a.carnivores -= Math.floor(a.carnivores * 0.1);
        } else {
            a.carnivores += Math.floor(a.carnivores * (growthRate / 2));
        }

        // Миграция при перенаселении
        if (a.herbivores > 2000) {
            let rKeys = Object.keys(World.regions).filter(k => k !== rId);
            let target = rKeys[Math.floor(Math.random() * rKeys.length)];
            let migrants = Math.floor(a.herbivores * 0.3);
            a.herbivores -= migrants;
            if (!World.animals[target]) World.animals[target] = { herbivores: 0, carnivores: 0 };
            World.animals[target].herbivores += migrants;
            if (Math.random() < 0.1) generateWorldNews(`Охотники сообщают: массовая миграция животных из ${r.name} в ${World.regions[target].name}.`, "global", 2);
        }

        // Влияние на экономику (охота)
        if (a.herbivores > 500 && r) {
            let hunted = Math.floor(a.herbivores * 0.05);
            a.herbivores -= hunted;
            r.resources.food += hunted * 2; // Мясо пополняет запасы еды региона
        }
    }

    // 7. Экономика Игрока (Банки и Владения)
    if (typeof player !== 'undefined' && player) {
        if (!player.bankAccount) player.bankAccount = { deposit: 0, loan: 0, loanDays: 0 };
        
        let bankMsg = "";
        if (player.bankAccount.deposit > 0) {
            let interest = Math.max(1, Math.floor(player.bankAccount.deposit * 0.01));
            player.bankAccount.deposit += interest;
        }
        if (player.bankAccount.loan > 0) {
            let penalty = Math.max(1, Math.floor(player.bankAccount.loan * 0.02));
            player.bankAccount.loan += penalty;
            player.bankAccount.loanDays--;
            if (player.bankAccount.loanDays <= 0) {
                generateWorldNews(`Коллекторы ищут ${player.name} за неуплату долга в ${player.bankAccount.loan} золотых!`, "global", 3);
                if (player.stats && player.stats.reputation) player.stats.reputation.global -= 5;
                player.bankAccount.loanDays = 5; // Продлеваем, но репутация падает
                bankMsg += "Кредит просрочен! Репутация падает. ";
            }
        }

        let dailyIncome = 0;
        if (player.holdings) {
            for (let hId in player.holdings) {
                let holding = player.holdings[hId];
                let profit = holding.baseProfit || 10;
                if (holding.region && World.regions[holding.region]) {
                    let r = World.regions[holding.region];
                    // Зависимость от занятости в регионе
                    let totalWorkforce = Math.floor(r.population * 0.6);
                    let totalJobs = (r.facilities.farms + r.facilities.lumbermills + r.facilities.mines + r.facilities.forges + r.facilities.weavers + r.facilities.alchemists) * 200;
                    let empRate = Math.min(1.0, totalJobs / totalWorkforce);
                    profit = Math.floor(profit * empRate);
                }
                dailyIncome += profit;
            }
        }
        ...
        if (dailyIncome > 0) {
            player.bankAccount.deposit += dailyIncome;
            bankMsg += `Владения принесли ${dailyIncome} з. (зачислено в банк).`;
        }
        
        if (bankMsg !== "") {
            if (typeof addCalculationMessage === 'function') addCalculationMessage(`[Экономика] ${bankMsg}`);
        }
        if (typeof updateHoldingsDisplay === 'function') updateHoldingsDisplay();
    }


    // 6. Устаревание новостей (УМНАЯ ПАМЯТЬ)
    for (let i = World.news.length - 1; i >= 0; i--) {
        World.news[i].daysOld++;
        // Мелкие слухи (importance < 4) удаляем через 7 дней.
        // Важные события (войны, захваты, катаклизмы) храним 60 дней!
        if ((World.news[i].importance < 4 && World.news[i].daysOld > 7) || World.news[i].daysOld > 60) {
            World.news.splice(i, 1);
        }
    }
}
...
function generateWorldNews(text, location, importance, category = 'misc') {
    ...
    console.log(`[WorldSim NEWS | ${category}]: ` + text);
}
    ...
    if (playerRegion) {
        for (let id in World.npcs) {
            ...
            if (npc.currentLocation === playerRegion && npc.isAlive) {
                ...
                let desc = `Профессия: ${npc.profession}. Сейчас: ${npc.currentActivity}. Настроение: ${npc.needs.hunger < 30 ? 'Голоден' : 'В норме'}.${memStr}`;
...
function buildFullPlayerSnapshot() {
    ...
    if (World) {
        ...
        if (playerRegion) {
            ...
            let ownerName = World.factions[r.owner] ? World.factions[r.owner].name : "Ничья земля";
            worldContextString += `[ВАША ЛОКАЦИЯ] Регион: ${r.name} (Владелец: ${ownerName}). Погода: ${World.weather[playerRegion] || "Нормальная"}\n`;
            worldContextString += `Рынок: Еда(${r.markets.food}), Дерево(${r.markets.wood}), Руда(${r.markets.ore}), Оружие(${r.markets.weapons})\n\n`;
        } else {
            worldContextString += "[ВАША ЛОКАЦИЯ] Игрок находится вне крупных симулируемых регионов.\n\n";
        }

        // 2. Фракции и Армии
        worldContextString += "[ФРАКЦИИ И ПОЛИТИКА]\n";
        let activeWars = [];
        let activeArmies = [];
        for (let fId in World.factions) {
            let f = World.factions[fId];
            worldContextString += `- ${f.name} | Казна: ${Math.floor(f.resources.gold)} | Еда: ${Math.floor(f.resources.food)} | Рекруты: ${Math.floor(f.resources.manpower)} | Стабильность: ${Math.floor(f.stability)}%\n`;
            
            for (let target in f.diplomacy) {
                if (f.diplomacy[target] === "war") {
                    let warStr = `${f.name} воюет с ${World.factions[target].name}`;
                    if (!activeWars.includes(`${World.factions[target].name} воюет с ${f.name}`)) activeWars.push(warStr);
                }
            }
            f.armies.forEach(a => {
                ...
                activeArmies.push(`${f.name}: ${a.size} воинов идут из ${locName} в ${destName} (дней пути: ${a.daysToMove})`);
            });
        }
        if (activeWars.length > 0) worldContextString += "Войны: " + activeWars.join(", ") + "\n";
        if (activeArmies.length > 0) worldContextString += "Передвижения войск: " + activeArmies.join("; ") + "\n";
        worldContextString += "\n";

        // 3. Регионы (Экономика и Экология)
        worldContextString += "[РЕГИОНЫ (ЭКОНОМИКА И ЭКОЛОГИЯ)]\n";
        for (let rId in World.regions) {
            let r = World.regions[rId];
            let an = World.animals[rId] || {herbivores: 0, carnivores: 0};
            worldContextString += `- ${r.name}: Поп. ${Math.floor(r.population)} | Ресурсы: Еда ${Math.floor(r.resources.food)}, Дерево ${Math.floor(r.resources.wood)}, Руда ${Math.floor(r.resources.ore)}, Оружие ${Math.floor(r.resources.weapons)} | Звери: Травоядные ${Math.floor(an.herbivores)}, Хищники ${Math.floor(an.carnivores)}\n`;
        }
        worldContextString += "\n";

        // 4. Историческая сводка для ИИ
        // Передаем ИИ все важные события за последнее время
        let recentNews = World.news.filter(n => n.daysOld <= 60);
        if (recentNews.length > 0) {
            worldContextString += "[ИСТОРИЯ МИРА ЗА ПОСЛЕДНЕЕ ВРЕМЯ]\n" + recentNews.map(n => `- (${n.daysOld} дн. назад): ${n.text}`).join("\n") + "\n";
        }
        worldContextString += "==================================================\n";
    }
...
БАНК И ВЛАДЕНИЯ:
Депозит: ${player.bankAccount?.deposit || 0} | Кредит: ${player.bankAccount?.loan || 0} (Осталось дней: ${player.bankAccount?.loanDays || 0})
Недвижимость/Бизнес: ${Object.keys(player.holdings || {}).length > 0 ? JSON.stringify(player.holdings, null, 2) : 'Нет'}
...
ОТКРЫТЫЕ ПОДЛОКАЦИИ (ВНУТРИ ДРУГИХ МЕСТ):
${JSON.stringify(player.subLocations, null, 2)}
...
async function loadGame(slotType, slotId) {
    ...
    if (saveData) {
        try {
            ...
            if (saveData.worldData) { World = structuredClone(saveData.worldData); } else { World = initWorldSimulator(); }
...
function initSettingsUI() {
    ...
    if (localMapCheckbox) localMapCheckbox.checked = enableLocalMap;
    ...
    // Инициализация внутренних вкладок (Sub-tabs)
...
function saveSettings() {
    ...
    if (localMapCheckbox) {
        enableLocalMap = localMapCheckbox.checked;
        localStorage.setItem('enableLocalMap', enableLocalMap);
        
        // Мгновенное обновление видимости панели
...
function advanceTime(pulses) {
    ...
    if (enableWorldSim && typeof updateWorldSimulation === 'function') updateWorldSimulation(pulses);
    updateTimeDisplay();
}
...
function updateWorldChroniclesDisplay() {
    ...
    // Обработчики для кнопок фильтров (назначаются один раз)
    ...
    filterBtns.forEach(btn => {
        btn.onclick = (e) => {
            ...
            updateWorldChroniclesDisplay();
    updateTradeJournalDisplay(); // Перерисовываем с новым фильтром
        };
    });

    // 1. Глобальные события (Nexus)
    ...
    if (currentChronicleFilter !== 'all') {
        ...
        // Глобальные события от ИИ всегда показываем, если фильтр не строгий, но можно и скрыть
        if (currentChronicleFilter !== 'war' && currentChronicleFilter !== 'disaster') events = []; 
    }

    if (events.length === 0 && simNews.length === 0) {
        listEl.innerHTML = `<li style="color:#7f8c8d; padding:10px; text-align:center;">В этой категории пока нет записей...</li>`;
        return;
    }

    // Рендерим глобальные события (Nexus)
    events.sort((a, b) => a.name.localeCompare(b.name)).forEach(ev => {
        ...
        li.innerHTML = `
            <div style="display:flex; justify-content: space-between; align-items: flex-start;">
                ...
                <span class="${statusClass}">${statusIcon} ${ev.value.toUpperCase()}</span>
            </div>
    ...
    // Рендерим фоновые слухи (World Sim)
...
function updateTradeJournalDisplay() {
    ...
    if (!playerRegionId) {
        listEl.innerHTML = `<li style="color:#7f8c8d; padding:5px; text-align:center;">Вы находитесь в глуши. Рынки недоступны.</li>`;
        return;
    }
    ...
    const formatPrice = (name, price, icon) => `
        <li style="display:flex; justify-content:space-between; padding: 3px 0;">
            <span style="color:#bdc3c7">${icon} ${name}</span>
            <span style="color:#f5b041; font-weight:bold;">${price} 💰</span>
        </li>`;

    html += formatPrice("Провизия", prices.food, "🍞");
    html += formatPrice("Древесина", prices.wood, "🪵");
    html += formatPrice("Руда", prices.ore, "🪨");
    html += formatPrice("Травы", prices.herbs, "🌿");
    html += formatPrice("Сталь", prices.steel, "⛓️");
    html += formatPrice("Ткани", prices.cloth, "🧵");
    html += formatPrice("Оружие", prices.weapons, "⚔️");
    html += formatPrice("Зелья", prices.potions, "🧪");
    html += formatPrice("Роскошь", prices.luxury, "🍷");
    ...
    for (let good in prices) {
        let ratio = prices[good] / (BASE_ECONOMY_PRICES[good] || 1);
    ...
    if (deficitGood) {
        const goodNames = {food: "провизии", wood: "древесины", ore: "руды", herbs: "трав", steel: "стали", cloth: "тканей", weapons: "оружия", potions: "зелий", luxury: "предметов роскоши"};
        html += `<li style="color:#e74c3c; font-size: 0.9em; margin-top: 5px; line-height: 1.3;">⚠️ Острый дефицит ${goodNames[deficitGood] || deficitGood}! Цены завышены.</li>`;
    }
...
function repeatLastAction() {
    if (isWaitingForAI || !player || !lastUserMessageForRetry) return;
    
    // Если в последнем сообщении были системные теги бросков, мы их очищаем для ввода,
    // так как handleUserInput сам сгенерирует новые или возьмет из контейнера.
    const cleanText = lastUserMessageForRetry.replace(/\[ROLL_RESULT:.*?\]/gi, '').trim();
...
Игровое время: День ${player.gameTime.day}, ${player.gameTime.hour < 10 ? '0'+player.gameTime.hour : player.gameTime.hour}:${player.gameTime.minute < 10 ? '0'+player.gameTime.minute : player.gameTime.minute} (${player.timeOfDay})`, "system-message");
            updateCharacterSheet();
        }
        else if (cmd === 'test') {
            runUnitTests();
...
async function performAiFetch(systemInstruction, history, providerModel, currentInput = "") {
    ...
    if (timeSinceLastRequest < API_DELAY_MS) {
        const waitTime = API_DELAY_MS - timeSinceLastRequest;
    ...
    if (cleanRaw.startsWith('[')) {
        try {
            ...
            if (Array.isArray(parsedArray)) {
                actions = parsedArray;
                return { narrative: "(( Системное действие выполнено. Мастер Игры забыл написать художественный текст. ))", actions, logic_summary, image_prompt };
            }
        } catch(e) {
...
Формат:
{
  "image_prompt": "Описание сцены на АНГЛИЙСКОМ языке для генератора картинок (ОБЯЗАТЕЛЬНО).",
...
case 'calculationLog':
            ...
            case 'bankTransaction':
                ...
                if (args.type === 'deposit') {
                    ...
                    player.stats.gold += amount;
                    player.bankAccount.loanDays = args.days || 14;
    ...
    updateTradeJournalDisplay();
            ...
            case 'addEnvironment':
                if (args.aiIdentifier && args.name && args.type) {
                    // Привязка: если не указана, привязываем к текущей локации
                    const binding = args.boundTo || player.location;
                    
                    // Сохраняем в глобальный реестр всех NPC мира
                    player.allKnownEntities[args.aiIdentifier] = {
                        aiIdentifier: args.aiIdentifier,
                        name: args.name,
                        type: args.type,
                        description: args.description || '',
                        stats: { hp: args.hp ?? 10, maxHp: args.maxHp ?? 10, str: args.str ?? 10, dex: args.dex ?? 10, con: args.con ?? 10, int: args.int ?? 10 },
                        isHostile: args.isHostile === true,
                        xpReward: args.xpReward || 20,
                        boundTo: binding,
                        traits: args.traits || []
                    };

                    updateEnvironmentVisibility();
                    feedback = `[Мир] Существо ${args.name} теперь связано с: ${binding === 'player' ? 'Вами' : binding}.`;
                } else {
            ...
            case 'revealEntityTrait':
                if (args.id && args.trait) {
                    const entityKey = Object.keys(player.visibleEntities).find(id => player.visibleEntities[id].aiIdentifier?.toLowerCase() === args.id.toLowerCase());
                    if (entityKey) {
                        const entity = player.visibleEntities[entityKey];
                        if (!entity.traits) entity.traits = [];
                        if (!entity.traits.includes(args.trait)) {
                            entity.traits.push(args.trait);
            ...
            case 'equipItem':
                if (args.aiIdentifier) {
                    ...
                    if (itemKey) {
                        ...
                        // Инициализируем счетчик попыток, чтобы избежать бесконечного цикла
                        args._retries = args._retries || 0;
                        
                        if (args._retries < 5) {
                            args._retries++;
                            console.warn(`[executeCommand] Команда equipItem для '${args.aiIdentifier}' не нашла предмет. Попытка ${args._retries}/5 через 50мс.`);
                            setTimeout(() => executeCommand(command, args), 50);
                            return null; 
                        } else {
                            feedback = `[ERROR] Не удалось экипировать '${args.aiIdentifier}'. Предмет не найден в инвентаре. GM забыл команду addItem?`;
                        }
                    }
                } else {
...
async function autoSaveGame() {
    if (!player || !gameInterface.classList.contains('active-screen') || isWaitingForAI) return;
...
function handleBeforeUnload(event) {
    if (player && gameInterface.classList.contains('active-screen')) {
        ...
        autoSaveGame().then(() => {
            console.log("Финильное автосохранение завершено.");
            // В Electron мы можем успеть показать нативный алерт
            if (window.electronAPI) alert(t('gameInterface.log.exitSaveSuccess', 'Игра успешно сохранена перед выходом!'));
        }).catch(err => console.error("Ошибка автосохранения в beforeunload:", err));
    }
    stopAutoSaveTimer();
...
async function runDeepSetupPipeline(narratorStyleGuide) {
    ...
    try {
        ...
        (res1.actions || []).forEach(a => executeCommand(a.command, a.args));
        ...
        (res2.actions || []).forEach(a => executeCommand(a.command, a.args));
        ...
        (res4.actions || []).forEach(a => executeCommand(a.command, a.args));
...
async function runWorldSimulationTick() {
    ...
    try {
        // Собираем актуальную сводку из JS-симуляции для нейросети
        let worldSummary = "=== ТЕКУЩЕЕ СОСТОЯНИЕ МИРА (СИМУЛЯЦИЯ) ===\n";
        for (let rId in World.regions) {
            let r = World.regions[rId];
            let ownerName = World.factions[r.owner] ? World.factions[r.owner].name : "Нет владельца";
            worldSummary += `Регион: ${r.name} (Владелец: ${ownerName}). Население: ${r.population}. Погода: ${World.weather[rId]}. Еда: ${r.resources.food}. Дерево: ${r.resources.wood}. Оружие: ${r.resources.weapons}.\n`;
        }
        
        let activeWars = [];
        for (let fId in World.factions) {
            let f = World.factions[fId];
            worldSummary += `Фракция: ${f.name}. Стабильность: ${f.stability}/100. Золото: ${f.resources.gold}. Армий в походе: ${f.armies.length}.\n`;
            for (let target in f.diplomacy) {
        ...
        let recentNews = World.news.filter(n => n.daysOld <= 3).map(n => n.text).join(" | ");
        worldSummary += `\nПоследние системные новости: ${recentNews || "Ничего особенного"}\n`;

        const fantasyMonths = ["Утренней Звезды", "Ледолома", "Ветровея", "Цветеня", "Солнцеворота", "Знойника", "Жатвеня", "Листопада", "Хладника", "Мертвой Луны", "Темного Рубежа", "Конца Года"];
        let currentDateStr = `${player.gameTime.day} ${fantasyMonths[player.gameTime.month - 1]}, ${player.gameTime.year} года`;
        
        // Вычисляем, сколько дней прошло с прошлого отчета ИИ
        if (!World.time.lastAiPulse) World.time.lastAiPulse = player.gameTime.totalPulses;
        let daysPassed = Math.floor((player.gameTime.totalPulses - World.time.lastAiPulse) / 288);
        if (daysPassed < 1) daysPassed = 1;
        World.time.lastAiPulse = player.gameTime.totalPulses;

        const prompt = `Ты — ДВИЖОК МИРА (WORLD SIMULATOR). Твоя задача: проанализировать сухие цифры текущего состояния экономики, политики и экологии, и сгенерировать ОДНО крупное мировое событие, логично вытекающее из этих данных.\n\n[ВРЕМЕННОЙ СКАЧОК]: С момента твоего прошлого отчета прошло дней: ${daysPassed}.\nТекущая дата в мире: ${currentDateStr}\n\n${worldSummary}\n\nЛокация игрока сейчас: ${player.location}\n\nПРИКАЗ:\n1. Верни СТРОГО JSON. Никакого текста до или после.\n2. Проанализируй данные. Если прошло много дней (например, месяц), опиши МАСШТАБНЫЕ изменения за этот период (затяжные осады, вымирание городов от голода, смену власти). Если прошел 1 день — опиши локальное событие.\n3. В массиве actions используй 'nexusDefine', чтобы закрепить это событие в мире (category: 'World_Event', displayType: 'text', value: 'АКТИВНО').\n4. ЕСЛИ событие происходит в той же локации, где сейчас игрок, ты ИМЕЕШЬ ПРАВО выдать ему квест через 'addQuest'.\n5. В поле 'narrative' напиши ЭПИЧНЫЙ ХУДОЖЕСТВЕННЫЙ ТЕКСТ (2-3 абзаца) в виде глобальной летописи. Обязательно упомяни, сколько времени прошло и текущую дату. Опиши масштабы, страх людей и последствия.`;
        
        const modelId = currentApiProvider === 'gemini' ? geminiModelId : (currentApiProvider === 'llmost' ? llmostModelId : openrouterModelId);
        const raw = await performAiFetch(prompt, [], modelId, `Генерируй событие для хода ${player.stats.turnCount}`);
        ...
        if (loaderDiv) loaderDiv.remove();
        addLogMessage("(( Сбой симуляции мира. Нейросеть не смогла обработать данные. ))", "system-message");
    } finally { 
    ...
    if (DEBUG_MODE && typeof World !== 'undefined' && World) {
        ...
        for (let fId in World.factions) {
            ...
            html += `<div class="debug-item">
                     ...
                     💰${Math.floor(f.resources.gold)} | 🛡️${Math.floor(f.resources.manpower)}
        ...
        for (let fId in World.factions) {
            World.factions[fId].armies.forEach(a => {
                ...
                html += `<div class="debug-army-item">
                            <b>${World.factions[fId].name}</b> (${a.size} ед.) ➔ <b>${dest}</b><br>
                            Статус: ${statusText}
                         </div>`;
            });
        }
        ...
        for (let rId in World.regions) {
            ...
            let totalWorkforce = Math.floor(r.population * 0.6);
            let totalJobs = (r.facilities.farms + r.facilities.lumbermills + r.facilities.mines + r.facilities.forges + r.facilities.weavers + r.facilities.alchemists) * 200;
            let empRate = Math.floor(Math.min(1.0, totalJobs / totalWorkforce) * 100);
            ...
            html += `<div class="debug-item">
                     ...
                     Склад: 🍖${Math.floor(r.resources.food)} 🪨${Math.floor(r.resources.ore)} ⛓️${Math.floor(r.resources.steel)} 🧪${Math.floor(r.resources.potions)}
                     </div>`;
        }
        html += '</div></div>';
