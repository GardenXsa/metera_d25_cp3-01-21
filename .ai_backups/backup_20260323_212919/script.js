                ...
                if (args.aiIdentifier && args.trait) {
                    ...
                    if (entityKey) {
                        ...
                        if (!entity.traits.includes(args.trait)) {
                            ...
                            feedback = `[СИСТЕМА] Раскрыта черта характера ${entity.name}: ${args.trait}`;
                            updateEnvironmentPanel();
                        }
                    } else {
                        feedback = `[ERROR] Существо '${args.aiIdentifier}' не найдено для раскрытия черты.`;
                    }
                } else {
                    feedback = `[ERROR] 'revealEntityTrait' требует 'aiIdentifier' и 'trait'.`;
                }
                break;
            case 'setCombatState':
