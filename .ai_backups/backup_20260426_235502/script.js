...
[КРИТИЧЕСКИЙ ТАЙМИНГ]: С твоего последнего отчета в мире официально прошло дней: ${daysPassed}.
Текущая дата: ${currentDateStr}

${worldSummary}

ПРИКАЗЫ:
1. ТЫ ОБЯЗАН НАЧАТЬ ТЕКСТ (поле narrative) С УКАЗАНИЯ ВРЕМЕНИ. Если прошло 14 дней, ты не имеешь права писать 'прошел день'. Описывай последствия ДВУХНЕДЕЛЬНОГО отсутствия игрока или развития событий.
2. Если прошло много дней, события ДОЛЖНЫ БЫТЬ масштабными (захваты городов, эпидемии, крах рынков).
3. В поле 'narrative' пиши в стиле исторической хроники или Вестей из Эфира.
4. Верни строго JSON.`;
