...
function handleBeforeUnload(event) {
    if (player && gameInterface.classList.contains('active-screen') && !IS_PRE_SIMULATING && tempPlayer === null) {
        console.log("Beforeunload: Попытка финального автосохранения...");
        // Убрали alert, так как в Electron он вызывает зависание (deadlock) при закрытии окна
